...
class BBA_8th_SEM extends StatefulWidget {
  const BBA_8th_SEM({Key? key}) : super(key: key);

  @override
  State<BBA_8th_SEM> createState() => _BBA_8th_SEMState();
}
...
class _BBA_8th_SEMState extends State<BBA_8th_SEM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("BBA 8th Semester Book"),
      ),
