...
class eee_3y_1s extends StatefulWidget {
  const eee_3y_1s({Key? key}) : super(key: key);

  @override
  State<eee_3y_1s> createState() => _eee_3y_1sState();
}
...
class _eee_3y_1sState extends State<eee_3y_1s> {
  @override
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => eee_3ye_1se(pdfUrl: pdfUrls[i]),
                            ),
                          );
                        },
                        child: Padding(
...
class eee_3ye_1se extends StatelessWidget {
  final String pdfUrl;

  const eee_3ye_1se({Key? key, required this.pdfUrl}) : super(key: key);
