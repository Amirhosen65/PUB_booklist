...
class eee_4y_2se extends StatefulWidget {
  const eee_4y_2se({Key? key}) : super(key: key);

  @override
  State<eee_4y_2se> createState() => _eee_4y_2seState();
}
...
class _eee_4y_2seState extends State<eee_4y_2se> {
  @override
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => eee_4ye_2se(pdfUrl: pdfUrls[i]),
                            ),
                          );
                        },
                        child: Padding(
...
class eee_4ye_2se extends StatelessWidget {
  final String pdfUrl;

  const eee_4ye_2se({Key? key, required this.pdfUrl}) : super(key: key);
