...
class Islamic_2y_2s extends StatefulWidget {
  const Islamic_2y_2s({Key? key}) : super(key: key);

  @override
  State<Islamic_2y_2s> createState() => _Islamic_2y_2sState();
}
...
class _Islamic_2y_2sState extends State<Islamic_2y_2s> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Islamic Studies 2nd Year 2nd Semester Book"),
      ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => is_2ye_2se(pdfUrl: pdfUrls[i]),
                            ),
                          );
                        },
                        child: Padding(
...
class is_2ye_2se extends StatelessWidget {
  final String pdfUrl;

  const is_2ye_2se({Key? key, required this.pdfUrl}) : super(key: key);
